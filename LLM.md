# zen-agentic-dataset — AI Knowledge Base

**Project**: zen-agentic-dataset
**Organization**: zenlm
**Repository**: https://github.com/zenlm/zen-agentic-dataset
**HuggingFace**: https://huggingface.co/zenlm/zen-agentic-dataset
**Last Updated**: 2026-02-27

## Overview

zen-agentic-dataset is part of the Zen AI model family by Hanzo AI / Zen LM.
